...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/summer-sound-f45d)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/summer-sound-f45d
```

A live public deployment of this template is available at [https://summer-sound-f45d.templates.workers.dev](https://summer-sound-f45d.templates.workers.dev)
